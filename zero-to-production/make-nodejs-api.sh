...
# USAGE
#
# make-nodejs-api.sh -a API-NAME -l LAMBDA-NAME
#
# E.g., calling make-nodejs-api.sh -a my-api -l MyHttpLambda
# This will:
...
usage="Usage: make-nodejs-api.sh -a API-NAME -l LAMBDA-NAME"
